...
// maior ou igual a `3`, crie um novo campo chamado `num_favs`, que represente quantos atores ou
// atrizes da nossa lista de favoritos aparecem no elenco (campo `cast`) do filme.

// Ordene os resultados por `num_favs`, `tomatoes.viewer.rating` e `title`, todos em ordem decrescente.

// Por fim, utilizando o mesmo _pipeline_, responda: Qual o **título** do vigésimo
