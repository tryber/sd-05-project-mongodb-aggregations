...
- o operador $all seleciona todos os documentos em que o valor do campo
é um array que contenha todos os elementos especificados;
- o operador $in seleciona qualquer um (any) dos valores especificados no array;
funciona similar ao operador $or;
- o operador $nin seleciona nenhum (none) dos valores especificados no array;
